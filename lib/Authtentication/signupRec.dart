...
class SignUpRec extends StatefulWidget {
  const SignUpRec({Key? key}) : super(key: key);

  @override
  State<SignUpRec> createState() => _SignUpState();
}

class _SignUpState extends State<SignUpRec> {
                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            db
                                ...
                                .then((_) {
                              // After successful user creation, navigate to the login screen
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => const LoginScreenRec()),
